...
class RewardManager():
    ...
    def __init__(self, tokenizer, num_examine, is_val=False, log_file=None) -> None:
    ...
    def __call__(self, data: DataProto):
        ...
        def process_item(args):
            ...
            score, info = compute_score_fn(solution_str=sequences_str, ground_truth=ground_truth, is_val=is_val)
...
def main_task(config):
    ...
    reward_fn = RewardManager(tokenizer=tokenizer, num_examine=0, log_file=config.reward_fn.log_file)
